...
def get_flashattention_autograd_function_triton() -> type:
    ...
    Returns:
        A class object (not an instance of the class)
    """
    from cs336_systems.flash_attention.flash_leaderboard import FlashAttention2Triton
...
def get_ddp_individual_parameters(module: torch.nn.Module) -> torch.nn.Module:
    ...
    from cs336_systems.ddp.ddp_overlap_ind_params import DDPIndividualParameters
...
def ddp_individual_parameters_on_after_backward(ddp_model: torch.nn.Module, optimizer: torch.optim.Optimizer):
    ...
    ddp_model.finish_gradient_synchronization()  # pyright: ignore[reportCallIssue]
...
def get_ddp_bucketed(module: torch.nn.Module, bucket_size_mb: float) -> torch.nn.Module:
    ...
    Returns:
        Instance of a DDP class.
    """
    from cs336_systems.ddp.ddp_overlap_bucketed import DDPOverLapBucket
